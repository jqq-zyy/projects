            ...
            <div class="panel">
                ...
                <div class="panel-body">
                    <div id="echartsBox">
                        ...
                        <div id="echartsScanTime" style="height: 400px;"></div>
...
<script type="text/ecmascript-6">
    ...
    import eCharts_scanOrder from './../../../js/eCharts/template/scanOrder';
    ...
    export default {
        ...
        methods: {
            ...
            initEcharts(){
                eCharts("echartsScanTime", eCharts_scanOrder, [{
                    name: "扫码次数",
                    list: this.dataList,
                    color: "#1cb2f0",
                    type: "line",
            ...
            onUpdate_echartsData(){
                ...
                g.net.call("statistic/consumeTimeStatistic", {
                    'startTime': this.date.startTimeStr,
                    'endTime':this.date.endTimeStr,
                    'activityIds':activityList
                }).then(($data) =>
                {
                    g.data.scanTimeEchartsPool.removeAll();
                    g.data.scanTimeEchartsPool.update($data.data);
                    this.dataList = g.data.scanTimeEchartsPool.dataList;
                    this.timeList = g.data.scanTimeEchartsPool.timeList;
					if(_hash){
