            ...
            <div class="panel">
                ...
                <div class="panel-body">
                    <div id="echartsBox">
                        ...
                        <div id="echartsQrcodeCount" style="height: 400px;"></div>
...
<script type="text/ecmascript-6">
    ...
    export default {
        ...
        methods: {
            ...
            initEcharts(){
                eCharts("echartsQrcodeCount", eCharts_scanOrder, [{
                    name: "扫码次数",
                    list: this.dataList,
                    color: "#1cb2f0",
                    type: "line",
            ...
            onUpdate_echartsData(){
                ...
                g.net.call("statistic/sweepQrcodeTrendStatistic", {
                    'startTime': this.date.startTimeStr,
                    'endTime':this.date.endTimeStr,
                    'activityIds':activityList
                }).then(($data) =>
                {
                    g.data.qrcodeCountEchartsPool.removeAll();
