                            ...
                            <div class="admin-calendar-table user-detail-box">
                                ...
                                <div class="detail-msg">
                                    ...
                                    <div class="upload-box">
                                        ...
                                        <div class="enterprise-msg">
                                            <img :src="infoObj.businessLicense" alt="" v-show="infoObj.businessLicense"
                                                 class="pointer" @click="onClick_seeImage(infoObj.businessLicense)">
                                            <img v-show="!infoObj.businessLicense"
                                                 :src="g.config.path.images+'/noHas.png'">
                                            <span>营业执照</span>
                                        </div>
                                        <div class="enterprise-msg">
                                            <img :src="infoObj.taxRegister" alt="" v-show="infoObj.taxRegister"
                                                 class="pointer" @click="onClick_seeImage(infoObj.taxRegister)">
                                            <img v-show="!infoObj.taxRegister" :src="g.config.path.images+'/noHas.png'">
                                            <span>税务登记证</span>
                                        </div>
                                        <div class="enterprise-msg">
                                            <img :src="infoObj.organizeCertificate" alt=""
                                                 v-show="infoObj.organizeCertificate" class="pointer"
                                                 @click="onClick_seeImage(infoObj.organizeCertificate)">
                                            <img v-show="!infoObj.organizeCertificate"
                                                 :src="g.config.path.images+'/noHas.png'">
                                            <span>组织结构代码证</span>
                                        </div>
                                    ...
                                    <div class="upload-box">
                                        ...
                                        <div class="enterprise-msg">
                                            <img :src="infoObj.idcardImagA" alt="" v-show="infoObj.idcardImagA"
                                                 class="pointer" @click="onClick_seeImage(infoObj.idcardImagA)">
                                            <img v-show="!infoObj.idcardImagA" :src="g.config.path.images+'/noHas.png'">
                                            <span>正面</span>
                                        </div>
                                        <div class="enterprise-msg">
                                            <img :src="infoObj.idcardImagB" alt="" v-show="infoObj.idcardImagB"
                                                 class="pointer" @click="onClick_seeImage(infoObj.idcardImagB)">
                                    ...
                                    <div class="upload-box">
                                        ...
                                        <div class="enterprise-msg">
                                            <img :src="infoObj.shopLogo" alt="" v-show="infoObj.shopLogo"
                                                 class="pointer" @click="onClick_seeImage(infoObj.shopLogo)">
                                    ...
                                    <div class="upload-box">
                                        ...
                                        <div v-for="item in infoObj.brandList" class="enterprise-msg"
                                             v-if="infoObj.brandList.length>0">
                                            <img :src="item.brandAuthorize" alt=""
                                                 @click="onClick_seeImage(item.brandAuthorize)" class="pointer">
                                            <span>{{item.brandName}}</span>
                                        </div>
                                        <img v-if="infoObj.brandList.length==0"
                                             :src="g.config.path.images+'/noHas.png'">
                    ...
                    <div class="pop-edit-password pop-edit">
                        ...
                        <div class="pop-body">
                            <div class="m-title">
								...
								<textarea cols="30" rows="10" class="describle-reasons"
