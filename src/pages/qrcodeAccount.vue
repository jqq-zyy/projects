                ...
                <div class="affix-box default-pos-type" v-show="isShow_refusePop">
                    <div class="pop-edit-password pop-edit">
                        ...
                        <div class="pop-body button-box">
                            ...
                            <div class="button-box m-margin-up " style="margin-top: 0" v-show="auditStatus==-1">
...
//                this.resultTotalObj.qrcodeAmount = info.qrcodeAmount;
            ...
            onUpdate_qrcodeList(){
                ...
                g.net.call("order/queryQrcodeAccountList", this.dataObj).then(($data) => {
            ...
            onClick_exportAllBtn(){
                window.open(g.webParam.url.server
                        + "/export/exportQrcodeTradeList?page=0&pageSize=0&startTime="
